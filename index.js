...
const invocationName = "name analyzer";
...
const UserFirstNameIntent_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'UserFirstNameIntent' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from UserFirstNameIntent. ';
        ...
        if( (slotValues.name.ERstatus === 'ER_SUCCESS_NO_MATCH') ||  (!slotValues.name.heardAs) ) {
            slotStatus += 'A few valid values are, ' + sayArray(getExampleSlotValues('UserFirstNameIntent','name'), 'or');
        }
...
const UserGenderIntent_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'UserGenderIntent' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from UserGenderIntent. ';
...
exports.handler = skillBuilder
    .addRequestHandlers(
        ...
        UserFirstNameIntent_Handler, 
        UserGenderIntent_Handler, 
