...
const invocationName = "color expert";
...
const AMAZON_AddAction<object@Book,targetCollection@ReadingList>_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'AMAZON.AddAction<object@Book,targetCollection@ReadingList>' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from AMAZON.AddAction<object@Book,targetCollection@ReadingList>. ';
...
const AMAZON_AddAction<object@BookSeries,targetCollection@ReadingList>_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'AMAZON.AddAction<object@BookSeries,targetCollection@ReadingList>' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from AMAZON.AddAction<object@BookSeries,targetCollection@ReadingList>. ';
...
const AMAZON_ChooseAction<object@Book,sourceCollection@ReadingList>_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'AMAZON.ChooseAction<object@Book,sourceCollection@ReadingList>' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from AMAZON.ChooseAction<object@Book,sourceCollection@ReadingList>. ';
...
const AMAZON_ChooseAction<object@Book>_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'AMAZON.ChooseAction<object@Book>' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from AMAZON.ChooseAction<object@Book>. ';
...
const AMAZON_DeleteAction<object@Book,sourceCollection@ReadingList>_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'AMAZON.DeleteAction<object@Book,sourceCollection@ReadingList>' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from AMAZON.DeleteAction<object@Book,sourceCollection@ReadingList>. ';
...
const AMAZON_DeleteAction<object@BookSeries,sourceCollection@ReadingList>_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'AMAZON.DeleteAction<object@BookSeries,sourceCollection@ReadingList>' ;
    },
    handle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        const responseBuilder = handlerInput.responseBuilder;
        ...
        let say = 'Hello from AMAZON.DeleteAction<object@BookSeries,sourceCollection@ReadingList>. ';
...
exports.handler = skillBuilder
    .addRequestHandlers(
        ...
        AMAZON_AddAction<object@Book, 
        targetCollection@ReadingList>_Handler, 
        AMAZON_AddAction<object@BookSeries, 
        targetCollection@ReadingList>_Handler, 
        AMAZON_ChooseAction<object@Book, 
        sourceCollection@ReadingList>_Handler, 
        AMAZON_ChooseAction<object@Book>_Handler, 
        AMAZON_DeleteAction<object@Book, 
        sourceCollection@ReadingList>_Handler, 
        AMAZON_DeleteAction<object@BookSeries, 
        sourceCollection@ReadingList>_Handler, 
